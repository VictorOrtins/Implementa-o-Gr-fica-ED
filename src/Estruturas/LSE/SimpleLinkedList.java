...
public class SimpleLinkedList<T> extends Estrutura<T>{
    ...
    private T removeBeggining(){
        SimpleNode<T> formerHead = this.head;
    ...
    private T removeEnd(){
        ...
        formerEnd = temp.getNext();
        temp.setNext(null);

        sizePlus(-1);

        return formerEnd.getValue();

    }

    private T removeMiddle(int position){
    ...
    public String print(boolean pesquisaPosicao, int posicao, boolean pesquisaValor, T valor) {
        ...
        while(temp != null){
            ...
            //Se não for o último da linha e o último nó da lista
            ...
            //Fazer a conexão entre o último nó da linha de cima e o primeiro da linha de baixo
