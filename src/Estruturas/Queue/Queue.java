...
public class Queue<Type> extends Estrutura<Type>{
    ...
    @Override
    public boolean insert(Type value, int position) {
        return insert(value);
    }
    ...
    @Override
    public Type remove(int position) throws InvalidPositionException, EmptyStructureException {
        return remove();
    }
    ...
    @Override
    public String print(boolean pesquisaFinal, int nada, boolean pesquisaTopo, Type nulo) {
        ...
        while(temp != null){
            ...
            if(pesquisaTopo && contador_nodos == 1|| pesquisaFinal && contador_nodos == size){
